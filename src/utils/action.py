...
def click(driver, by, locator, timeout = 10):
    element = locator_method_dict[by](driver, locator, timeout)
    element.click()

    return element

def input_text(driver, by, locator, txt, timeout = 10):
    element = locator_method_dict[by](driver, locator, timeout)
    element.clear()
...
def get_text(driver, by, locator, timeout = 10):
    element = locator_method_dict[by](driver, locator, timeout)
    value = element.text

    return value

def get_attribute_value(driver, by, locator, timeout = 10):
    element = locator_method_dict[by](driver, locator, timeout)
